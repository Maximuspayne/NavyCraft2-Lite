...
public class MoveCraft_Timer {
	...
	public static HashMap<Craft, MoveCraft_Timer> takeoverTimers = new HashMap<Craft, MoveCraft_Timer>();
	public static HashMap<Craft, MoveCraft_Timer> abandonTimers = new HashMap<Craft, MoveCraft_Timer>();
